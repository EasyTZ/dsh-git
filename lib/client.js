window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = [
			...
			".dsgHistoryRow:hover{background:var(--dsw-alias-bg-layer-2,rgba(255,255,255,.05))}",
			".dsgHistoryRow:focus-visible{outline:2px solid var(--dsw-alias-button-primary-fill,#4d6bfe);outline-offset:-2px}",
			".dsgDetailMask{position:absolute;inset:0;z-index:20;display:flex;align-items:center;justify-content:center;padding:16px;background:rgba(0,0,0,.45);box-sizing:border-box}",
			...
			".dsgDetailClose:hover{background:rgba(128,128,128,.22);color:var(--dsw-alias-label-primary,#f9fafb)}",
			...
			".dsgDetailMsg{white-space:pre-wrap;overflow-wrap:anywhere;font-size:12.5px;line-height:1.65;color:var(--dsw-alias-label-primary,#f9fafb);background:var(--dsw-alias-bg-layer-2,rgba(255,255,255,.04));border-radius:8px;padding:9px 11px;margin-bottom:12px}",
			...
			".dsgDetailFile:hover{background:var(--dsw-alias-bg-layer-2,rgba(255,255,255,.05))}",
			...
			".dsgBadgeA{background:rgba(63,185,80,.18);color:var(--dsw-alias-state-success-primary,#3fb950)}",
			".dsgBadgeM{background:rgba(210,153,34,.18);color:var(--dsw-alias-state-warning-primary,#d29922)}",
			".dsgBadgeD{background:rgba(240,97,122,.18);color:var(--dsw-alias-state-error-primary,#f0617a)}",
			".dsgBadgeR{background:rgba(88,166,255,.18);color:#58a6ff}",
