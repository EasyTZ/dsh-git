window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = [
			...
			".dsgDetailCard{display:flex;flex-direction:column;width:100%;max-height:100%;background:var(--dsw-alias-bg-layer-1,#151517);border:1px solid var(--dsw-alias-border-l1,rgba(255,255,255,.1));border-radius:12px;box-shadow:0 12px 32px rgba(0,0,0,.45);overflow:hidden}",
